...
public class AuthzTokenIntrospector implements OpaqueTokenIntrospector {
  ...
  private static final String CLAIMS_KEY = "authzClaims";
  ...
  public OAuth2AuthenticatedPrincipal introspect(String token)
    ...
    try {
      ...
      Map<String, Object> claimsMap = Map.of(CLAIMS_KEY, claims);
  ...
  public static Optional<AuthZClaims> extractClaimsFromAuthentication(
    ...
    val claims = ((OAuth2AuthenticatedPrincipal) principal).getAttribute(CLAIMS_KEY);
